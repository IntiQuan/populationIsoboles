...
This vignette demonstrates how to use the fast isobole algorithm `grid_refinement` in the context of population simulation of NLME models.
...
The setup of the model is made this explicit, because the fast isoboles algorithm `grid_refinement` needs to reuse the individual parameters.
